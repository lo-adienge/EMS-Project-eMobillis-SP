...
<section class="hero-7-bg position-relative bg-gradient-primary" id="home">
    ...
    <div class="hero-login-form mx-auto p-4 rounded mt-5 mt-lg-0 bg-white">
        <div class="text-center">
            <h5 class="form-title mb-4">eMobillis Bootcamp Project</h5>
        </div>
        <!-- Bootstrap Carousel -->
        <div id="imageCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/ems1.jpeg" class="img-fluid mx-auto d-block" alt="Slide 1">
                </div>
                <div class="carousel-item">
                    <img src="images/ems2.jpeg"" class="img-fluid mx-auto d-block" alt="Slide 2">
                </div>
                <div class="carousel-item">
                    <img src="images/ems3.jpeg"" class="img-fluid mx-auto d-block" alt="Slide 3">
                </div>
            </div>
            <!-- Carousel controls -->
